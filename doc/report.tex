...
\end{figure}
  ...
  \item[Błąd negatywny] %TODO
  \item[Błąd pozytywny] %TODO
  \item[Graf DNA] %TODO
...
\begin{itemize}
 \item wielkość spektrum idealnego $n$
 \item ilość błędów $e$
...
Aby wygenerować ciąg którego spektrum idealne ma rozmiar $n$ z $e$ błedami pozytywnymi
wystarczy wygenerować łańcuch DNA o długości $n+l-1$ i do tak utworzonego spektrum 
dodać $e$ unikalnych oligonukleotydów.

Wygenerowanie instancji z błędami negatywnymi jest jeszcze prostrze. Najpierw należy
wygenerować łańcuch DNA o długości $n+e+l-1$, a następnie usunąć z tego spektrum
